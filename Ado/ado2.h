...
public:
	...
	inline ADODB::PositionEnum_Param GetAbsolutePage() { _ASSERT_VALID( m_pRecordset ); return m_pRecordset->GetAbsolutePage(); }
	inline void SetAbsolutePage( int nPage ) { _ASSERT_VALID( m_pRecordset ); m_pRecordset->PutAbsolutePage(( enum PositionEnum )nPage); }
	inline long GetPageCount() { _ASSERT_VALID( m_pRecordset ); return ( long )m_pRecordset->GetPageCount(); }
	...
	inline ADODB::PositionEnum_Param GetAbsolutePosition() { _ASSERT_VALID( m_pRecordset ); return m_pRecordset->GetAbsolutePosition(); }
