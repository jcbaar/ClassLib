...
void ClsXPMenu::PreDrawFrame( LPCRECT pRect, LPCRECT pRectScr )
{
	...
	//
	// 12-2-2007: Removed the following code bacause of it
	//            complete and utter incompatibilty with
	//			  Windows Vista. Note however that this code
	//			  will run properly under Windows XP and
	//			  lower.
	/*ClsRect rc;
