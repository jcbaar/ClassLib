...
protected:
	...
	class HookMan
	{
	  public:
		...
		std::list<ClsBalloonHelp*> m_lstClasses;
		int m_nCountKeyboard;
		int m_nCountMouse;
		int m_nCountCallWnd;
		ClsCriticalSection m_cs;

		HookMan();
		~HookMan();
		void AddClass(ClsBalloonHelp* pClass);
		void RemoveClass(ClsBalloonHelp* pClass);
