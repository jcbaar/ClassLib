...
// to the object.
UINT_PTR CALLBACK ClsFileDialog::HookProc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
	...
	switch ( pNMHDR->code )
	{
		...
		case	CDN_SHAREVIOLATION:
		{
			...
			if ( rc != OFN_SHAREWARN )
			{
				...
				SetWindowLong64( DWL_MESSAGERESULT, ( LONG_PTR )rc );
				return TRUE;
			}
			return FALSE;
		}
